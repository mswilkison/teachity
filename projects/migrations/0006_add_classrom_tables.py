...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Chatlog'
        db.create_table('projects_chatlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('classroom', self.gf('django.db.models.fields.related.ForeignKey')(related_name='chat_entries', to=orm['projects.Classroom'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('projects', ['Chatlog'])

        # Adding model 'Classroom'
        db.create_table('projects_classroom', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.OneToOneField')(related_name='classroom', unique=True, to=orm['projects.Project'])),
            ('session_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('projects', ['Classroom'])


    def backwards(self, orm):
        # Deleting model 'Chatlog'
        db.delete_table('projects_chatlog')

        # Deleting model 'Classroom'
        db.delete_table('projects_classroom')
    ...
    models = {
        ...
        'projects.chatlog': {
            'Meta': {'object_name': 'Chatlog'},
            'classroom': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'chat_entries'", 'to': "orm['projects.Classroom']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'projects.classroom': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'classroom'", 'unique': 'True', 'to': "orm['projects.Project']"}),
            'session_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'})
        },
        'projects.project': {
