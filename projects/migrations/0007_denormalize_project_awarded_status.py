...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.is_awarded'
        db.add_column('projects_project', 'is_awarded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        # Save all projects to populate new field
        if not db.dry_run:
    ...
    def backwards(self, orm):
        # Deleting field 'Project.is_awarded'
        db.delete_column('projects_project', 'is_awarded')
