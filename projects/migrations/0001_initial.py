...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('projects_projectfile', (
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_files', to=orm['projects.Project'])),
        ...
        # Adding model 'RequiredSkill'
        db.create_table('projects_requiredskill', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='required_skills', to=orm['projects.Project'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('projects', ['RequiredSkill'])

        # Adding model 'Project'
        db.create_table('projects_project', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='projects', to=orm['users.Student'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Category'], on_delete=models.PROTECT)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('recurring', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('budget_type', self.gf('django.db.models.fields.CharField')(default='hourly', max_length=7)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'RequiredSkill'
        db.delete_table('projects_requiredskill')
