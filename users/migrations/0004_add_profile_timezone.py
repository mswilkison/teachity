...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_timezone', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('users', ['Timezone'])

        # Adding field 'UserProfile.timezone'
        db.add_column('users_userprofile', 'timezone',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Timezone'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Timezone'
        db.delete_table('users_timezone')

        # Deleting field 'UserProfile.timezone'
        db.delete_column('users_userprofile', 'timezone_id')
    ...
    models = {
        ...
        'users.userprofile': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Country']", 'null': 'True', 'blank': 'True'}),
            ...
            'timezone': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Timezone']", 'null': 'True', 'blank': 'True'}),
