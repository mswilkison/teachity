...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_tutor', (
            ...
            ('other_qualifications', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('users', ['Tutor'])
    ...
    models = {
        ...
        'users.tutor': {
            ...
            'other_qualifications': ('django.db.models.fields.TextField', [], {}),
        ...
        'users.userprofile': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Country']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
